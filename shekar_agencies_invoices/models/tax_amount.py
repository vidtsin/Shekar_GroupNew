...
class AccountInvoice(models.Model):
    ...
    # z_customer_code=fields.Char("Customer code" compute="get_customer_code")
    # z_customer_code=fields.Char("Customer code",related="partner_id.ref_code")
    ...
    def _change_amount_words1(self):
        for line in self:
            if line.pricelist_id.id == 1:
                ...
                line.strom = str(line.word)+" "+" Dollars Only"
    ...
    #     pro = 0
    #     for line in self:
    #         var = self.env['res.partner'].search([('id','=',line.id.id)])
    #     z_customer_code=var
